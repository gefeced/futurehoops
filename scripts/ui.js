...
(() => {
  ...
  function cacheElements() {
    ...
    elements.journalExportButton = document.getElementById("journalExportButton");
    elements.journalImportButton = document.getElementById("journalImportButton");
    elements.journalImportInput = document.getElementById("journalImportInput");
    elements.journalTagInput = document.getElementById("journalTagInput");
    elements.journalAddTagButton = document.getElementById("journalAddTagButton");
    elements.journalSettingsTagList = document.getElementById("journalSettingsTagList");
    ...
    elements.bountiesSignupModal = document.getElementById("bountiesSignupModal");
    elements.bountiesSignupLater = document.getElementById("bountiesSignupLater");
    elements.bountiesSignupYes = document.getElementById("bountiesSignupYes");
    ...
    elements.importConflictModal = document.getElementById("importConflictModal");
    elements.importConflictModalTitle = document.getElementById("importConflictModalTitle");
    elements.importConflictModalBody = document.getElementById("importConflictModalBody");
    elements.importConflictModalCancel = document.getElementById("importConflictModalCancel");
    elements.importConflictModalCopy = document.getElementById("importConflictModalCopy");
    elements.importConflictModalOverwrite = document.getElementById("importConflictModalOverwrite");
    ...
    elements.athleteSubtabButtons = Array.from(
      document.querySelectorAll("[data-athlete-subtab]")
    );
    elements.athleteProfileViews = Array.from(
      document.querySelectorAll("[data-athlete-view]")
    );
    elements.athleteProfileName = document.getElementById("athleteProfileName");
    elements.athleteProfileTeam = document.getElementById("athleteProfileTeam");
    elements.athleteProfilePosition = document.getElementById("athleteProfilePosition");
    elements.athleteProfileClassYear = document.getElementById("athleteProfileClassYear");
    elements.athleteProfileHometown = document.getElementById("athleteProfileHometown");
    elements.athleteProfileJersey = document.getElementById("athleteProfileJersey");
    elements.athleteProfileBio = document.getElementById("athleteProfileBio");
    elements.athleteProfileBadge = document.getElementById("athleteProfileBadge");
    elements.athleteSummaryStrip = document.getElementById("athleteSummaryStrip");
    elements.athleteGameCount = document.getElementById("athleteGameCount");
    elements.athleteProfileStatus = document.getElementById("athleteProfileStatus");
    elements.athleteStatPpg = document.getElementById("athleteStatPpg");
    elements.athleteStatRpg = document.getElementById("athleteStatRpg");
    elements.athleteStatApg = document.getElementById("athleteStatApg");
    elements.athleteStatSpg = document.getElementById("athleteStatSpg");
    elements.athleteStatBpg = document.getElementById("athleteStatBpg");
    elements.athleteStatFg = document.getElementById("athleteStatFg");
    elements.athleteStatThree = document.getElementById("athleteStatThree");
    elements.athleteStatFt = document.getElementById("athleteStatFt");
    elements.athleteGameOpponent = document.getElementById("athleteGameOpponent");
    elements.athleteGameDate = document.getElementById("athleteGameDate");
    elements.athleteGamePoints = document.getElementById("athleteGamePoints");
    elements.athleteGameRebounds = document.getElementById("athleteGameRebounds");
    elements.athleteGameAssists = document.getElementById("athleteGameAssists");
    elements.athleteGameResult = document.getElementById("athleteGameResult");
    elements.athleteGameNotes = document.getElementById("athleteGameNotes");
    elements.athleteAddGame = document.getElementById("athleteAddGame");
    elements.athleteGameList = document.getElementById("athleteGameList");
    elements.athleteBountyTitle = document.getElementById("athleteBountyTitle");
    elements.athleteBountyUnit = document.getElementById("athleteBountyUnit");
    elements.athleteBountyCurrent = document.getElementById("athleteBountyCurrent");
    elements.athleteBountyTarget = document.getElementById("athleteBountyTarget");
    elements.athleteBountyDueDate = document.getElementById("athleteBountyDueDate");
    elements.athleteBountyStatus = document.getElementById("athleteBountyStatus");
    elements.athleteBountyNotes = document.getElementById("athleteBountyNotes");
    elements.athleteAddBounty = document.getElementById("athleteAddBounty");
    elements.athleteBountyList = document.getElementById("athleteBountyList");
    elements.athleteBountyBadge = document.getElementById("athleteBountyBadge");
    elements.journalMeta = document.getElementById("journalMeta");
    elements.journalListCard = document.getElementById("journalListCard");
    elements.journalFilterTag = document.getElementById("journalFilterTag");
    elements.journalEntryList = document.getElementById("journalEntryList");
    elements.journalPrevButton = document.getElementById("journalPrevButton");
    elements.journalListToggle = document.getElementById("journalListToggle");
    elements.journalNextButton = document.getElementById("journalNextButton");
    elements.journalNewEntryButton = document.getElementById("journalNewEntryButton");
    elements.journalTitleInput = document.getElementById("journalTitleInput");
    elements.journalTagList = document.getElementById("journalTagList");
    elements.journalBodyInput = document.getElementById("journalBodyInput");
    elements.journalMediaButton = document.getElementById("journalMediaButton");
    elements.journalMediaInput = document.getElementById("journalMediaInput");
    elements.journalMediaGrid = document.getElementById("journalMediaGrid");
    ...
    elements.designerCourtType = document.getElementById("designerCourtType");
    ...
    elements.designerDownloadPlay = document.getElementById("designerDownloadPlay");
    elements.designerUploadPlay = document.getElementById("designerUploadPlay");
    elements.designerUploadInput = document.getElementById("designerUploadInput");
  ...
  function setActiveTab(tab) {
    ...
    const allowedTabs = ["profile", "athlete", "designer", "journal", "settings"];
    ...
    if (!gameState.active) {
      ...
      } else if (nextTab === "athlete") {
        ui.handleAthleteProfileTabActivated?.();
      }
      syncMobileLayout();
      return;
    }
